...
document.getElementById('vr').addEventListener('click', filterSelection.bind(null, 'vr'));
...
document.getElementById('navbarStudy').addEventListener('click', moveTo.bind(null,'study'));
